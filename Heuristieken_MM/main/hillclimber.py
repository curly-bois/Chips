...
def hillsolve(max_tries, matrix, all_sets, unconnected_sets, connected_sets):
    ...
    while len(unconnected_sets) > 0 and hilltries < max_tries:
        hilltries += 1
        if hilltries == 1:
            print("???????????????????????????????????? show me the magic remember ?????????????????????????????????????????????")
            print("???????????????????????????????????? show me the magic remember ?????????????????????????????????????????????")
            print("???????????????????????????????????? show me the magic remember ?????????????????????????????????????????????")
            print("???????????????????????????????????? show me the magic remember ?????????????????????????????????????????????")
            print("???????????????????????????????????? show me the magic remember ?????????????????????????????????????????????")
        ...
        #                 wire_pieces += 1
        # print(f"TRY: {hilltries} TOTAL AMOUNT OF INITIAL WIRES in the whole matrix ooooniverse: {wire_pieces}")
        # print("*****************************************************")
        ...
        # #             if point.get_attribute() == "wire":
        # #                 wire_pieces += 1
        # # print(f"TRY: {hilltries} TOTAL AMOUNT OF WIRES in the whole matrix ooooniverse AFTER RECONNECTIONS: {wire_pieces}")
        # print("***")
        # print("***")
        # print("***")
